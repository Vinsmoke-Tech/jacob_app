...
class InstallmentsPrintPage extends StatefulWidget {
  const InstallmentsPrintPage({super.key});

  @override
  State<InstallmentsPrintPage> createState() => _InstallmentsPrintPageState();
}

class _InstallmentsPrintPageState extends State<InstallmentsPrintPage> {
  String username = '';
  String user_id = '';
