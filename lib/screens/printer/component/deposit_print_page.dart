...
class DepositPrintPage extends StatefulWidget {
  const DepositPrintPage({super.key});

  @override
  State<DepositPrintPage> createState() => _DepositPrintPageState();
}

class _DepositPrintPageState extends State<DepositPrintPage> {
  String username = '';
  String user_id = '';
