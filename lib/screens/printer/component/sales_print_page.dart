...
class SalesPrintPage extends StatefulWidget {
  const SalesPrintPage({super.key});
...
class _SalesPrintPageState extends State<SalesPrintPage> {
  ...
  loadSharedPreference() async {
    ...
    setState(() {
      ...
      printer_kitchen_address = prefs.getString('printer_kitchen_address')!;
    });
  }
  ...
  void printWithDevice(BluetoothDevice device) async {
    ...
    printer.add(
      gen.text(
        salesinvoice['table_no'].toString(),
        styles: const PosStyles(bold: true, align: PosAlign.center),
      ),
    );
    printer.add(gen.feed(1));
                                  ...
                                  SizedBox(
                                    ...
                                    child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          return (scanResult![index].device.name == printer_kitchen_address) ? Container(
                                            ...
                                            child: ListTile(
                                              ...
                                              title: Text(
                                                  "Printer Dapur : ${scanResult![index].device.name}",
                                                  style: TextStyle(
