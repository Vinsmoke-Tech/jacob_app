...
import 'package:jacob_app/screens/member_withdraw/member_withdraw.dart';
...
class WithdrawByMember extends StatefulWidget {

  late Map<String, dynamic> byMember;
  final String data;
  
  WithdrawByMember({required this.byMember, required  this.data});

  @override
  State<WithdrawByMember> createState() => _WithdrawByMemberState();
}

class _WithdrawByMemberState extends State<WithdrawByMember> {
  ...
  Navigator.push(
    context,
    MaterialPageRoute(
      builder: (context) => MemberWithdraw(bySaving: bySaving, data: 'savings_account_id',),
    ),
  );
}
}