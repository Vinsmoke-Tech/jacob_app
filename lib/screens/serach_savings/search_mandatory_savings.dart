...
class SearchMandatorySavings extends StatefulWidget {
  const SearchMandatorySavings({Key? key}) : super(key: key);

  @override
  State<SearchMandatorySavings> createState() => _SearchMandatorySavingsState();
}

class _SearchMandatorySavingsState extends State<SearchMandatorySavings> {
  String token = '';
