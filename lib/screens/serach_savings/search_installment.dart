...
import 'package:jacob_app/screens/installments/installments_list.dart';
...
class SearchInstallments extends StatefulWidget {
  const SearchInstallments({Key? key}) : super(key: key);

  @override
  State<SearchInstallments> createState() => _SearchInstallmentsState();
}

class _SearchInstallmentsState extends State<SearchInstallments> {
  String token = '';
              ...
              children: [
                IconButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) =>  InstallmentsList()),
                    );
                  },
